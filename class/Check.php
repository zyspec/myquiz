...
class Check extends \XoopsObject
{
    /**
     * Class Constructor
     */
    ...
    {
        parent::__construct();
        $this->initVar('idx', XOBJ_DTYPE_INT, null, false);
        $this->initVar('ip', XOBJ_DTYPE_TXTBOX, null, false, 20);
        $this->initVar('time', XOBJ_DTYPE_TXTBOX, null, false, 14);
        $this->initVar('username', XOBJ_DTYPE_TXTBOX, null, false, 50);
        $this->initVar('email', XOBJ_DTYPE_TXTBOX, null, false, 50);
        $this->initVar('qid', XOBJ_DTYPE_INT, 0, true);
        $this->initVar('score', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('answers', XOBJ_DTYPE_TXTBOX, null, false, 255);
    }
}
